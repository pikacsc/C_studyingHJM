...
int main()
{
	...
	*/
	...
	/*
		int* (*x[10])(void);
				  1				1. array of
			   2				2. function with no arguments
						3		3. functinos with no arugments
	...
	*/
	...
	/*in C programming,  A function can't return a fuction */
	//int g(int)(int); // Wrong
	...
	/* An array of functions arent's possible */
	...
	int borad[6][4]; // an array of arrays of int
	int** ptr;
